...
const TotalChars = ({totalCharacters,Sources}) => {
  ...
  return (
    <div className="w-3/4 md:w-1/2 lg:w-11/12">
      <div
        className={`w-full border border-gray-200 flex flex-col items-center`}
      >
        <div
          className={`flex flex-col justify-center items-center w-full p-3`}
        >
          ...
          <div className="w-11/12">
            <button className="btn block mt-4 px-4 py-2 rounded-md bg-gradient-to-r from-blue-300 via-purple-500 to-blue-200  font-semibold hover:opacity-90 my-2 w-full">
              Create Chatbot &#8230;
            </button>
          </div>
        </div>
