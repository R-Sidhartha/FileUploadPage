...
const Main = ({ isMobileView }) => {
  ...
  return (
    <>
      ...
      >
        <h2 className={`text-2xl font-bold p-4 text-center`}>Data Sources</h2>
        <div
        ...
        >
          <div className={`flex justify-center w-full ${isMobileView?' flex-col items-center ':''}`}>
            ...
            >
              <div
                className="rounded-2xl border-2 border-opacity-40 border-gray-500 uploadbox p-4 bg-gradient-to-b from-gray-100 via-white to-gray-100  shadow-lg mx-10 w-full h-96 relative cursor-pointer flex flex-col items-center"
                {...getRootProps()}
              >
                <div className="flex flex-col items-center justify-center mt-14">
                  ...
                  <h4 className=" mt-8 mb-16 text-center">
                    Drag and drop your file here to upload
                    <h6 className="text-sm opacity-70 my-2 text-center">
          ...
          <div className="mt-4 w-11/12">
            ...
            {files.length > 0 ? (
                      ...
                      <div className="flex flex-col items-center ">
                        <div className="flex w-full">
                          <a
                            ...
                            className={`cursor-pointer flex items-center hover:opacity-70 break-words w-3/4 `}
                          >
                            <img className="w-6 mx-1" src={filepng} alt="" />
                            <span className={`text-xs break-words w-11/12 ml-1`}>
              ...
              <h2 className="my-3 opacity-70 text-center">No Files Uploaded</h2>
            )}
          </div>
        </div>
      </div>
